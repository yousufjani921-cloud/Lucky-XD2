...
malvin({
    ...
    try {
        ...
        const prompt = encodeURIComponent("you are subzero md whatsapp bot made by Mr ʟᴜᴄᴋʏ ➋➊➑. a tech genius in Uganda. act smart and enigmatic about personal stuff about him. He is 25 years (2025).Every mesaage you reply put footer \n> Powered By Lucky Tech Hub 🤖");
        ...
        if (data && data.status && data.BK9) {
            ...
            reply("⚠️ Lucky AI failed to generate a response.");
        }
